...
ActiveRecord::Schema.define(version: 2019_02_17_001608) do
  ...
  create_table "addresses", force: :cascade do |t|
    ...
    t.index ["owning_organization_id"], name: "index_addresses_on_owning_organization_id"
  end
  ...
  create_table "attachments", force: :cascade do |t|
    ...
    t.index ["owning_organization_id"], name: "index_attachments_on_owning_organization_id"
  end
  ...
  create_table "authentications", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["owning_organization_id"], name: "index_authentications_on_owning_organization_id"
  ...
  create_table "categories", force: :cascade do |t|
    ...
    t.index ["owning_organization_id"], name: "index_categories_on_owning_organization_id"
  ...
  create_table "emails", force: :cascade do |t|
    ...
    t.index ["owning_organization_id"], name: "index_emails_on_owning_organization_id"
  end
  ...
  create_table "images", force: :cascade do |t|
    ...
    t.index ["owning_organization_id"], name: "index_images_on_owning_organization_id"
  end
  ...
  create_table "item_lead_mappings", force: :cascade do |t|
    ...
    t.index ["owning_organization_id"], name: "index_item_lead_mappings_on_owning_organization_id"
  end
  ...
  create_table "item_testimonial_mappings", force: :cascade do |t|
    ...
    t.index ["owning_organization_id"], name: "index_item_testimonial_mappings_on_owning_organization_id"
  ...
  create_table "items", force: :cascade do |t|
    ...
    t.index ["owning_organization_id"], name: "index_items_on_owning_organization_id"
  ...
  create_table "leads", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["owning_organization_id"], name: "index_leads_on_owning_organization_id"
  end
  ...
  create_table "people", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["owning_organization_id"], name: "index_people_on_owning_organization_id"
  ...
  create_table "phones", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["owning_organization_id"], name: "index_phones_on_owning_organization_id"
  ...
  create_table "posts", force: :cascade do |t|
    ...
    t.index ["owning_organization_id"], name: "index_posts_on_owning_organization_id"
  ...
  create_table "social_proofs", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["owning_organization_id"], name: "index_social_proofs_on_owning_organization_id"
  ...
  create_table "testimonials", force: :cascade do |t|
    ...
    t.index ["owning_organization_id"], name: "index_testimonials_on_owning_organization_id"
    t.index ["person_id"], name: "index_testimonials_on_person_id"
  end

  add_foreign_key "addresses", "organizations", column: "owning_organization_id"
  add_foreign_key "attachments", "organizations", column: "owning_organization_id"
  add_foreign_key "authentications", "organizations", column: "owning_organization_id"
  add_foreign_key "authentications", "people"
  add_foreign_key "categories", "images", column: "primary_image_id"
  add_foreign_key "categories", "organizations", column: "owning_organization_id"
  add_foreign_key "emails", "organizations", column: "owning_organization_id"
  add_foreign_key "images", "organizations", column: "owning_organization_id"
  add_foreign_key "item_lead_mappings", "items"
  add_foreign_key "item_lead_mappings", "leads"
  add_foreign_key "item_lead_mappings", "organizations", column: "owning_organization_id"
  add_foreign_key "item_testimonial_mappings", "items"
  add_foreign_key "item_testimonial_mappings", "organizations", column: "owning_organization_id"
  ...
  add_foreign_key "items", "organizations", column: "owning_organization_id"
  add_foreign_key "leads", "organizations", column: "owning_organization_id"
  ...
  add_foreign_key "people", "organizations", column: "owning_organization_id"
  add_foreign_key "people", "phones", column: "primary_phone_id"
  add_foreign_key "phones", "organizations", column: "owning_organization_id"
  add_foreign_key "posts", "images", column: "primary_image_id"
  add_foreign_key "posts", "organizations", column: "owning_organization_id"
  add_foreign_key "posts", "people", column: "author_id"
  add_foreign_key "social_proofs", "images", column: "primary_image_id"
  add_foreign_key "social_proofs", "organizations", column: "owning_organization_id"
  add_foreign_key "testimonials", "images", column: "after_image_id"
  add_foreign_key "testimonials", "images", column: "before_image_id"
  add_foreign_key "testimonials", "organizations", column: "owning_organization_id"
